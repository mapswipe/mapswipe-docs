...
The newly added export contains aggregated stats for all MapSwipe projects, grouped by the 7 project types, instantly revealing each type's project count, total area covered, every swipe submitted, and average volunteers per project.
...
| ----------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| project_type                        | integer | The numeric code representing the type of projects aggregated in this row (e.g., 1=Find features, 2=Validate footprints, 3=Compare dates, 4=Check completeness, 7=View streets, 9=Locate objects, 10=Assess Images). |
| project_type_display                | string  | The human-readable name of the project type corresponding to the project_type code, as displayed in the app (e.g., "Find features", "Validate footprints", "Compare dates", "Check completeness", "View streets", "Locate objects", "Assess Images").     |
