...
| project_type                   | integer | The type of the project, represented as a numeric code (e.g., 1=Find features, 2=Validate footprints, 3=Compare dates, 4=Check completeness, 7=View streets, 9=Locate objects, 10=Assess Images).                        |
| project_type_display           | string  | Human-readable name of the project type corresponding to the project_type code (e.g., "Find features", "Validate footprints", "Compare dates", "Check completeness", "View streets", "Locate objects", "Assess Images"). |
